export const experience = {
    ...
    experience_details: {
        developed_maintained:
            "Développé et maintenu l'application web de médias numériques et marketing, réduisant le temps de chargement des pages de 30% avec React.js, en priorisant l'UX et l'accessibilité.",
        implemented_metrics:
            "Mis en place des métriques quotidiennes d'utilisation et de performance avec OpenTelemetry, intégré à Datadog pour la surveillance, générant une amélioration de performance de 25%.",
        authored_unit_tests:
            "Créé une base de tests unitaires réutilisables, augmentant l'efficacité du contrôle qualité de plus de 30% et identifiant les bugs et problèmes d'accessibilité web.",
        engaged_with_architects:
            "Collaboré étroitement avec l'architecte logiciel et les ingénieurs backend pour superviser les API et optimiser le flux de travail logiciel avec Scrum, entraînant une réduction de 25% du temps de livraison et une amélioration du taux de réussite.",
        implemented_servicenow:
            "Implémenté des applications ServiceNow personnalisées en utilisant des fonctionnalités avancées telles que Flow Designer, Service Catalog, SLA, ACL et Mobile Agent.",
        configured_email:
            "Configuré des notifications par e-mail avec les protocoles SMTP et POP3 pour informer les utilisateurs des activités spécifiques dans le système.",
        collaborated_departments:
            "Collaboré avec les départements et les parties prenantes de l'entreprise pour traduire les exigences commerciales en exigences fonctionnelles dans ServiceNow.",
        ...
        led_early_stage:
            "Dirigé, en tant qu'ingénieur frontend de début de projet, le développement de notre produit phare, collaborant étroitement avec le designer UI/UX pour transformer les maquettes en interfaces réactives et impeccables, priorisant le plaisir de l'utilisateur.",
        developed_frontend_features:
            "Développé des fonctionnalités frontend pour la version MVP du produit, en se concentrant sur la performance, l'évolutivité et la maintenabilité.",
        integrated_monitoring:
            "Intégré des outils de surveillance et d'analyse tels que LogRocket et NewRelic pour recueillir des informations sur les interactions des utilisateurs, les métriques de performance et les erreurs d'application, augmentant l'efficacité du produit de 40%.",
        implemented_hubspot:
            "Implémenté des codes de suivi et des formulaires HubSpot pour capturer les données et le comportement des utilisateurs, permettant des campagnes marketing automatisées et personnalisées, l'engagement des clients et des communications ciblées.",
        integrated_thinkific:
            "Intégré des interfaces frontend affichant les cours, modules et leçons Thinkific, assurant une expérience utilisateur fluide. Configuré les API Thinkific pour l'authentification, l'inscription et le suivi des progrès directement dans le frontend.",
        ...
        spearheaded_development:
            "Dirigé le développement et la maintenance de SavePlus, une application web de crowdfunding à but lucratif, en tant que seul ingénieur frontend de l'équipe. Pris en charge le processus de développement frontend, assurant un code de haute qualité et une expérience utilisateur fluide.",
        participated_code_reviews:
            "Participé activement aux revues de code et au débogage, pour maintenir la stabilité et les performances de l'application, et contribué à l'amélioration continue de SavePlus en fournissant des idées et des suggestions pour les optimisations et les nouvelles fonctionnalités.",
        implemented_e2e_tests:
            "Implémenté des tests automatisés de bout en bout en utilisant CypressJS pour assurer la fiabilité et la qualité de l'application sur différents navigateurs et appareils.",
        worked_payment_integration:
            "Travaillé sur l'intégration des paiements avec divers canaux de Mobile Money, Visa & MasterCard, et PayPal, assurant des processus de transaction sécurisés et fluides pour les utilisateurs.",
        implemented_multi_language:
            "Implémenté le support multi-langues pour l'application, améliorant l'accessibilité et l'expérience utilisateur de 45%.",
        used_php_lumen:
            "Utilisé PHP/Lumen et Angular 7 sur le tableau de bord administratif pour améliorer les capacités d'EzyAgric, permettant une cartographie précise des jardins, facilitant l'accès à des services authentiques, des registres agricoles, des finances et des marchés de qualité, augmentant l'efficacité du produit de 25%, tout en donnant aux agriculteurs un accès facile aux ressources vitales.",
        ...
        implemented_backend:
            "Implémenté des solutions backend avec Node/ExpressJS et PostgreSQL pour Tembea, rationalisant les demandes de taxi et la gestion des itinéraires, augmentant l'efficacité opérationnelle de 30% pour le département des opérations d'Andela et les fellows placés chez les partenaires.",
        integrated_slack:
        ...
        led_agile:
            "Dirigé le processus de développement Agile en utilisant des outils de gestion de projet comme PivotalTracker, assurant une allocation efficace des tâches et un suivi des progrès, résultant en une augmentation de 20% de la vélocité de développement.",
        deployed_cross_platform:
            "Déployé avec succès des applications multi-plateformes construites avec Ionic 3 sur plusieurs plateformes mobiles, y compris Android, iOS et Windows Phone, assurant la compatibilité à travers divers systèmes d'exploitation."
    }
};

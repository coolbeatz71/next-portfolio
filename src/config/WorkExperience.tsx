            ...
            <div>
                ...
                <div className="gap-4">
                    <ul className="list-disc space-y-2 pl-5 leading-relaxed">
                        ...
                        <li>
                            Engaged closely with Software Architect and Backend
                            engineers to oversee APIs and streamline software
                            workflow with Scrum, resulting in a 25% decrease in
                            delivery time and improve success rate.
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div className="gap-4">
                    <ul className="list-disc space-y-2 pl-5 leading-relaxed">
                        <li>
                            ...
                            Service Catalog, SLAs, ACLs and Mobile Agent.
                        </li>
                        <li>
                            Configured Email Notifications with SMTP, POP3
                            protocols to notify users about specific activities
                            in the system.
                        </li>
                        <li>
                            Collaborated with Departments and Business
                            stakeholders to translate business requirements into
                            functional requirements within ServiceNow.
                        </li>
                        <li>
                            Developed various UI Actions, and Policies, Client
                            Scripts, Business Rules, Inbound and Outbound Email,
                            Catalog Client Scripts, and created Scheduled Job,
                            Critical Reports, Gauges as per the Business needs.
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div className="gap-4">
                    <ul className="list-disc space-y-2 pl-5 leading-relaxed">
                        <li>
                            ...
                            traffic by an impressive 40%, driving greater user
                            engagement and brand recognition.
                        </li>
                        <li>
                            Led the frontend team, steering them towards
                            excellence while delivering constructive feedback,
                            resulting in a 30% improvement in code quality.
                            Acted as a mentor to junior developers, fostering a
                            collaborative, growth-oriented atmosphere within the
                            company.
                        </li>
                        <li>
                            ...
                            ElasticSearch, achieving a 20% increase in system
                ...
                <div className="gap-4">
                    <ul className="list-disc space-y-2 pl-5 leading-relaxed">
                        <li>
                            ...
                            closely with the UI/UX designer to transform mockups
                            into responsive flawless interfaces, prioritizing
                            user delight.
                        </li>
                        <li>
                            Developed frontend features for the MVP version of
                            the product, focusing on performance, scalability,
                            and maintainability.
                        </li>
                        <li>
                            Integrated monitoring and analytics tools such as
                            LogRocket and NewRelic to gather insights into user
                            interactions, performance metrics, and application
                            errors, increasing the product efficiency by 40%.
                        </li>
                        <li>
                            Implemented HubSpot tracking codes and forms to
                            capture user data and behavior, enabling automated
                            and personalized marketing campaigns, customer
        ...
        content: (
            <div>
                <p className="text-neutral-400 italic dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 !leading-loose">
                    ...
                    celebrate the rich legacy and contributions of the
                    community.
                </p>
                <div className="gap-4">
                    <ul className="list-disc space-y-2 pl-5 leading-relaxed">
                        <li>
                            ...
                            user experience. Configured Thinkific APIs for
                            authentication, enrolment, and progress tracking
                            directly within the frontend.
                        </li>
                        <li>
                            Maintained an intuitive admin dashboard to
                            facilitate efficient management of platform content,
                            courses, user data, and system settings.
                        </li>
                        <li>
                            Achieved a 30% improvement in application
                            performance and maintainability through successfully
                            re-architecting the entire customer-facing frontend
                            application, integrating Clean Code and
                        ...
                        <li>
                            ...
                            improving development efficiency and code delivery
                            by 70%.
                        </li>
                    </ul>
                </div>

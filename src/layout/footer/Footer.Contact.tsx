...
export function FooterContact() {
    ...
    return (
        <div className="flex flex-col items-start gap-2">
            ...
            <span className="w-full md:w-auto justify-start text-text-contact flex items-center gap-2">
                <IconLocation />
            ...
            >
                <span className="hover:underline text-text-contact hover:text-primary-on-accent hover:text-primary-on-accent flex justify-start items-center gap-2">
                    <IconEmail />

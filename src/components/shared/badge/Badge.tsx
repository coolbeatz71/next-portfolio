...
export default function Badge({
    ...
    return (
        <div
            className={cn(
                "relative backdrop-blur-sm bg-gradient-to-b from-gray-100 to-slate-200/60 dark:from-gray-600 dark:to-slate-700/60 p-3 md:p-4 rounded-lg overflow-hidden z-10 shadow-xl flex justify-around items-center",
                className
            )}
        >

...
function GridPatternBackgroundComponent({
    size
    ...
    return (
        <div className="pointer-events-none absolute left-0 top-0 h-full w-full [mask-image:linear-gradient(white,transparent)]">
            <div
                className={`absolute inset-0 z-50 bg-gradient-to-r [mask-image:radial-gradient(farthest-side_at_top,white,transparent)]

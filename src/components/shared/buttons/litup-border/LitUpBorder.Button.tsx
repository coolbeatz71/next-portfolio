...
export default function LitUpBorderButton({
    ...
    return (
        <button type="button" className={cn("p-1 relative", className)}>
            ...
            <div className="w-full py-1.5 bg-slate-100 dark:bg-slate-800 rounded relative group transition duration-100 text-slate-700 dark:text-slate-200 hover:text-white hover:bg-transparent">
                {children}
            </div>
        </button>
    );

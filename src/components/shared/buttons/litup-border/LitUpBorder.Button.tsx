...
export default function LitUpBorderButton({
    ...
    return (
        <button type="button" className={cn("p-1 relative", className)}>
            ...
            <div className="w-full py-1 bg-gray-800 dark:bg-gray-100 rounded-[6px]  relative group transition duration-200 text-white hover:text-white dark:text-black hover:bg-transparent">
                {children}
            </div>
        </button>
    );

...
export function GradientShineButton({
    ...
    return (
        <button
            type="button"
            className={cn(
                "relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-medium text-primary-on-accent transition duration-moderate ease-out rounded-lg group hover:ring-[3px] hover:ring-ring-primary",
                className
            )}
        >
            ...
            <span className="relative text-text-on-primary font-medium text-sm">
                {children}
            </span>
        </button>
    );
